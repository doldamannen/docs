...
While adding facial and voice data can aide our model in monitoring, it is not always necessary; our model can find your voice and images from learning, even if it is not provided explicitly.
